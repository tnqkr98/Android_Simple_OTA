...
class LEManager(context: Context) : BleManager<LeManagerCallbacks>(context) {
    ...
    companion object {
        ...
        val OTA_TX_CHARACTERISTIC: UUID = UUID.fromString("6e400002-b5a3-f393-e0a9-e50e24dcca9e")
        val OTA_RX_CHARACTERISTIC: UUID = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e")
